...
{
    public class CCriteriaHrTaxDocumentKor : CCriteriaBase
    {
        ...
        public CCriteriaHrTaxDocumentKor() : base(new MVTaxDocument(new CTable("")), "CCriteriaHrTaxDocumentKor")
        {
        }
        ...
        public void ShowEditWindowEx(MVTaxDocument actDoc)
        {
            ...
            if (dt == TaxDocumentType.TaxDocRev1)
            {
                ...
                FactoryWindow.ShowWindow("WinAddEditTaxFormPRV1Kor", param);
            }
