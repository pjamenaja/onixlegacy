...
{
    public class CReportEmployee00_04_EmployeeRevenue : CBaseReport
    {
        ...
        public CReportEmployee00_04_EmployeeRevenue() : base()
        {
        }
        ...
        {
            ArrayList arr = OnixWebServiceAPI.GetListAPI("GetEmployeeRevenueMonthSummary", "EMPLOYEE_TAX_RECORDS", Parameter);
            return (arr);
        }
