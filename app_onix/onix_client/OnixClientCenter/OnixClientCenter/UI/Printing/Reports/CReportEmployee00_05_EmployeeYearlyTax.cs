...
{
    public class CReportEmployee00_05_EmployeeYearlyTax : CBaseReport
    {
        ...
        public CReportEmployee00_05_EmployeeYearlyTax() : base()
        {
        }
        ...
        private void configReport()
        {
            ...
            addConfig("L1", 15, "name_prefix", HorizontalAlignment.Center, HorizontalAlignment.Left, HorizontalAlignment.Center, "NAME_PREFIX_DESC", "S", false);
            addConfig("L1", 55, "employee_name", HorizontalAlignment.Center, HorizontalAlignment.Left, HorizontalAlignment.Center, "EMPLOYEE_NAME_LASTNAME", "S", false);

            addConfig("L1", 15, "revenue", HorizontalAlignment.Center, HorizontalAlignment.Right, HorizontalAlignment.Right, "RECEIVE_AMOUNT", "DD", true);
            addConfig("L1", 15, "tax", HorizontalAlignment.Center, HorizontalAlignment.Right, HorizontalAlignment.Right, "DEDUCT_TAX", "DD", true);            
            addConfig("L1", 15, "social_insurance", HorizontalAlignment.Center, HorizontalAlignment.Right, HorizontalAlignment.Right, "DEDUCT_SOCIAL_SECURITY", "DD", true);
        }

        protected override ArrayList getRecordSet()
        {
            ArrayList arr = OnixWebServiceAPI.GetListAPI("GetEmployeeYearlySummary", "EMPLOYEE_YEARLY_SUMMARY", Parameter);
            return (arr);
        }
