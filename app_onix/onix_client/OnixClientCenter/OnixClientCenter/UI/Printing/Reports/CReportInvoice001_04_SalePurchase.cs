...
{
    public class CReportInvoice001_04_SalePurchase : CBaseReport
    {
        ...
        public CReportInvoice001_04_SalePurchase() : base()
        {
        }
        ...
        private void configReport()
        {
            ...
            addConfig("L1", 35, "description", HorizontalAlignment.Center, HorizontalAlignment.Left, HorizontalAlignment.Center, "DOCUMENT_DESC", "S", false);
            ...
            addConfig("L1", 5, "redeem_flag", HorizontalAlignment.Center, HorizontalAlignment.Center, HorizontalAlignment.Center, "REDEEM_FLAG", "S", false);
        ...
        protected override ArrayList getRecordSet()
        {
            ...
            arr = OnixWebServiceAPI.GetListAPI("GetSaleInvoicePurchaseTxByPoProjectGroup", "SALE_PURCHASE_DOC_TX_LIST", Parameter);
